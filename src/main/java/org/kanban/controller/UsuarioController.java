...
public class UsuarioController {
	...
	public ResponseEntity<?> TareaByUserId(@PathVariable("user_id")  Long user_id) {
	...
	public ResponseEntity<?> updateUsuario(@PathVariable("id")Long id ,@RequestBody CreaUsuarioDTO user) {
		if(!usuarioService.existsById(id))
