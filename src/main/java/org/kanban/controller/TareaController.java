...
public ResponseEntity<Usuario>TareaById(@PathVariable Long id) {
...
@ApiOperation(notes = 
"Eliminar tarea, para fines de prueba nos permitimos eliminar, no es buena practica eliminar información de una base de datos" 
